...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_ImageLoader_t, stringdata) + ofs \
...
QT_MOC_LITERAL(2, 21, 4)
    },
    "ImageLoader\0imagedir\0QDir\0"
};
...
const QMetaObject ImageLoader::staticMetaObject = {
    { &PipelineStage::staticMetaObject, qt_meta_stringdata_ImageLoader.data,
      qt_meta_data_ImageLoader,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_ImageLoader.stringdata))
